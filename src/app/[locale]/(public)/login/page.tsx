...
export default function LoginPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-10 md:py-16">
      <div className="grid overflow-hidden rounded-[2.4rem] border border-border/70 bg-card/90 shadow-[0_28px_90px_-44px_rgba(45,35,24,0.4)] lg:grid-cols-[1.1fr_0.9fr]">
        <div className="relative min-h-[24rem] overflow-hidden px-8 py-10 md:px-12 md:py-14">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-br from-black/82 via-black/58 to-black/30" />
        ...
        <div className="flex items-center px-5 py-8 md:px-8 md:py-12">
          <Card className="w-full rounded-[2rem] border-border/70 bg-background/80 shadow-none">
            <CardHeader className="text-center">
              ...
              <CardTitle className="font-display text-4xl tracking-[0.03em]">{t("login")}</CardTitle>
